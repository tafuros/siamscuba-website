      ...
      <main className="pt-28 pb-16">
        ...
        <article className="container mx-auto px-4 max-w-3xl mt-12">
          ...
          <Section id="why-koh-tao" title="למה דווקא קוטאו?">
            ...
            <p>
              <strong>1. המחיר.</strong> קורס PADI Open Water אצלנו עולה 12,000 בת (כ-1,250 שקל). אותו קורס בקריביים
          ...
          <Section id="mehirim" title="מחירי קורסי הצלילה ב-Siam Scuba (2026)">
            ...
            <ul className="space-y-2 mr-4 list-disc">
              ...
              <li>
                <strong>PADI Advanced Open Water (כוכב שני):</strong> 11,000 בת. 2 ימים, 5 צלילות הרפתקאה כולל עומק
                וניווט. מעלה אתכם ל-30 מטר.
              </li>
              <li>
                <strong>PADI Rescue Diver (Rescue) + EFR:</strong> 16,000 בת (11,000 + 5,000). 4 ימים. הקורס שכל מי
          ...
          <Section id="takziv" title="תקציב לטיול הצלילה (כמה זה באמת עולה)">
            ...
            <p>
              <strong>סיכום ל-4 ימים בקוטאו עם קורס Open Water:</strong> 18,000-26,000 בת באי (כ-1,900-2,700 שקל),
              ועוד הטיסה מישראל. סך הכל בערך 6,600-9,600 שקל לטיול שלם.
            </p>
          </Section>
