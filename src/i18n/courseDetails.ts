  ...
  en: {
    ...
    "Open Water Diver": {
      ...
      payment: [
        ...
        "Deposit is non-refundable ❌",
        "Reschedule up to 12 hours before",
        "No refund if you stop the course, for any reason ❌",
    ...
    "Advanced Open Water": {
      ...
      itinerary: [
        ...
        { day: "Day 2", description: "05:50 - Early departure for Deep dive (30m) + Wreck dive. 09:00 - Break. 10:00 - Second dive. 11:30 - Back to club, certification & celebration 🎉" },
      ],
      included: [
    ...
    "Self-Reliant Diver": {
      header: "🤿 PADI Self-Reliant Diver - Dive Independently",
      intro: "Train as an experienced diver to dive safely on your own or as a more self-sufficient buddy by carrying backup equipment. Especially valuable for underwater photographers and videographers who need operational independence.",
      structure: [
        "Duration: 1.5 days (flexible scheduling available)",
        "Instructor-led knowledge development sessions + knowledge review",
        "3 open water training dives",
      ],
      learns: [
        "Self-reliant diver mentality and redundancy concepts",
        "Equipment configuration for independent diving",
        "Calculating SAC rates (Surface Air Consumption)",
        "Emergency management using self-reliance principles",
        "Self-rescue skills and DSMB deployment",
        "Mask-off swimming and out-of-air simulations",
        "Navigation and gas awareness",
      ],
      included: [
        "3 training dives",
        "PADI Certification card",
  ...
  he: {
    ...
    "Open Water Diver": {
      ...
      payment: [
        ...
        "המקדמה אינה ניתנת להחזר ❌",
        "אפשר לשנות מועד עד 12 שעות מראש",
        "לא ינתן החזר כספי בהפסקת הקורס מכל סיבה שהיא ❌",
    ...
    "Advanced Open Water": {
      ...
      itinerary: [
        ...
        { day: "יום 2", description: "05:50 - יציאה מוקדמת לצלילה עמוקה (30 מ') + צלילת מבנה טבוע. 09:00 - הפסקה. 10:00 - צלילה שנייה. 11:30 - חזרה למועדון, הסמכה וחגיגה 🎉" },
      ],
      included: [
    ...
    "Self-Reliant Diver": {
      header: "🤿 PADI Self-Reliant Diver - צוללן עצמאי",
      intro: "הכשרה לצוללנים מנוסים לצלול בבטחה באופן עצמאי או כבן-זוג עצמאי יותר באמצעות נשיאת ציוד גיבוי. בעל ערך מיוחד לצלמי סטילס ווידאו תת-ימיים הזקוקים לעצמאות תפעולית.",
      structure: [
        "משך: יום וחצי (לוח זמנים גמיש זמין)",
        "מפגשי פיתוח ידע בהדרכת מדריך + מבחן ידע",
        "3 צלילות הכשרה במים פתוחים",
      ],
      learns: [
        "תפיסת הצוללן העצמאי ועקרונות היתירות",
        "תצורת ציוד לצלילה עצמאית",
        "חישוב קצב צריכת אוויר (SAC)",
        "ניהול מצבי חירום על פי עקרונות עצמאות",
        "מיומנויות חילוץ עצמי ופריסת מצוף (DSMB)",
        "שחייה ללא מסכה וסימולציות חוסר אוויר",
        "ניווט ומודעות לכמות האוויר",
      ],
      included: [
        "3 צלילות הכשרה",
        "כרטיס הסמכה PADI",
        "השכרת כל ציוד הצלילה",
        "שימוש חופשי במחשב צלילה",
        "יומן צלילות",
        "עד 4 תלמידים למדריך PADI",
      ],
      prerequisites: [
        "צוללן מוסמך PADI Advanced Open Water",
        "מינימום 100 צלילות מתועדות",
        "גיל 18 ומעלה",
        "כשירות רפואית לצלילה",
        "השלמת הערכת מיומנויות",
      ],
      price: "13,000 THB",
    },
    "IDC (Instructor Course)": {
  ...
  es: {
    ...
    "Open Water Diver": {
      ...
      payment: [
        ...
        "El depósito no es reembolsable ❌",
        "Puedes reprogramar hasta 12 horas antes",
        "No hay reembolso si interrumpes el curso, por cualquier motivo ❌",
    ...
    "Advanced Open Water": {
      ...
      itinerary: [
        ...
        { day: "Día 2", description: "05:50 - Salida temprana para inmersión profunda (30 m) + inmersión en pecio. 09:00 - Descanso. 10:00 - Segunda inmersión. 11:30 - De vuelta al club, certificación y celebración 🎉" },
      ],
      included: [
    ...
    "Self-Reliant Diver": {
      header: "🤿 PADI Self-Reliant Diver - Bucea de forma independiente",
      intro: "Formación para buceadores experimentados que quieren bucear de forma segura por su cuenta o como un compañero más autosuficiente llevando equipo de respaldo. Especialmente valioso para fotógrafos y videógrafos submarinos que necesitan independencia operativa.",
      structure: [
        "Duración: 1,5 días (horario flexible disponible)",
        "Sesiones de desarrollo de conocimientos dirigidas por el instructor + repaso de conocimientos",
        "3 inmersiones de entrenamiento en aguas abiertas",
      ],
      learns: [
        "Mentalidad del buceador autosuficiente y conceptos de redundancia",
        "Configuración del equipo para el buceo independiente",
        "Cálculo de la tasa de consumo de aire en superficie (SAC)",
        "Gestión de emergencias con principios de autosuficiencia",
        "Habilidades de autorrescate y despliegue de DSMB",
        "Natación sin máscara y simulacros de quedarse sin aire",
        "Navegación y conciencia del gas",
      ],
      included: [
        "3 inmersiones de entrenamiento",
        "Tarjeta de certificación PADI",
        "Alquiler de todo el equipo de buceo",
        "Uso GRATIS de ordenador de buceo",
        "Libro de registro",
        "Máximo 4 estudiantes por instructor PADI",
      ],
      prerequisites: [
        "Buceador certificado PADI Advanced Open Water",
        "Mínimo 100 inmersiones registradas",
        "18 años o más",
        "Médicamente apto para bucear",
  ...
  fr: {
    ...
    "Open Water Diver": {
      ...
      payment: [
        ...
        "L'acompte n'est pas remboursable ❌",
        "Report possible jusqu'à 12 heures avant",
        "Aucun remboursement en cas d'arrêt du cours, quelle qu'en soit la raison ❌",
    ...
    "Advanced Open Water": {
      ...
      itinerary: [
        ...
        { day: "Jour 2", description: "05h50 - Départ matinal pour la plongée profonde (30 m) + plongée sur épave. 09h00 - Pause. 10h00 - Deuxième plongée. 11h30 - Retour au club, certification et célébration 🎉" },
      ],
      included: [
    ...
    "Self-Reliant Diver": {
      header: "🤿 PADI Self-Reliant Diver - Plongez en autonomie",
      intro: "Formation pour les plongeurs expérimentés souhaitant plonger en toute sécurité en solo ou en tant que coéquipier plus autonome en transportant un équipement de secours. Particulièrement utile pour les photographes et vidéastes sous-marins ayant besoin d'autonomie opérationnelle.",
      structure: [
        "Durée : 1,5 jour (horaires flexibles disponibles)",
        "Sessions de développement des connaissances animées par l'instructeur + révision des connaissances",
        "3 plongées d'entraînement en eau libre",
      ],
      learns: [
        "Mentalité du plongeur autonome et concepts de redondance",
        "Configuration de l'équipement pour la plongée autonome",
        "Calcul du taux de consommation d'air en surface (SAC)",
        "Gestion des urgences selon les principes d'autonomie",
        "Compétences d'auto-sauvetage et déploiement du DSMB",
        "Nage sans masque et simulations de panne d'air",
        "Navigation et gestion du gaz",
      ],
      included: [
        "3 plongées d'entraînement",
        "Carte de certification PADI",
        "Location de tout l'équipement de plongée",
        "Utilisation GRATUITE d'un ordinateur de plongée",
        "Carnet de plongée",
      ...
      prerequisites: [
        "Plongeur certifié PADI Advanced Open Water",
        "Minimum 100 plongées enregistrées",
        "18 ans ou plus",
        "Médicalement apte à la plongée",
        "Réaliser une évaluation des compétences",
      ],
      price: "13,000 THB",
    },
    "IDC (Instructor Course)": {
