...
export const translations: Record<Language, TranslationStrings> = {
  en: {
    ...
    hl_children: "For children, in shallow sea",
  ...
  es: {
    ...
    hl_children: "Para niños, en mar poco profundo",
    ...
    cta_subtitle: "Envíanos un mensaje por WhatsApp y te reservamos en minutos. Un depósito pequeño te guarda la plaza — ¡y luego solo ven y bucea!",
  ...
  fr: {
    ...
    cta_subtitle: "Envoyez-nous un message sur WhatsApp et nous vous réservons en quelques minutes. Un petit acompte réserve votre place — ensuite venez simplement plonger !",
