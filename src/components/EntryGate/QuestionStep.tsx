        ...
        {question.options.map((opt, i) => {
          ...
          return (
            <motion.button
              ...
              className={`gate-card group flex min-h-[8.5rem] items-center justify-center rounded-2xl p-6 text-center backdrop-blur-md outline-none transition-colors ${sideArt ? "gap-4" : "flex-col gap-2"} ${orderClass}`}
            >
              {art && (
                <DiverArt
                  type={art}
